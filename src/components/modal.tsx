        ...
        <>
            <form
                onSubmit={handleSubmit(async () => {
                    const filelist = (document.getElementById(`fileupl-${item?.id}`) as HTMLInputElement)
                        .files as FileList;
                    ...
                    <div className="px-4 z-10 relative">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 justify-items-center items-center place-items-center">
                            <div className="form-control w-full max-w-xs">
                                ...
                                />
                                {errors.name && (
                                    <p className="text-red-500 mt-1 text-center font-light">{errors.name.message}</p>
                                )}
                            </div>
                            <div className="form-control w-full max-w-xs">
                                <label className="label">
                            ...
                            <div className="form-control w-full max-w-xs">
                                ...
                                {errors.price && (
                                    <p className="text-red-500 mt-1 text-center font-light">{errors.price.message}</p>
                                )}
                            </div>
                            <div className="form-control w-full max-w-xs">
                                <label className="label">
                    ...
                    <div className="p-4 text-base-content z-10 relative cursor-default">
                        ...
                        <div className="forms border border-base-content border-opacity-30 py-4 rounded shadow-lg my-4">
                            <div className="form-control w-full max-w-xs mx-auto my-2">
                                ...
                                {errors.role && (
                                    <p className="text-red-500 mt-1 text-center font-light">{errors.role.message}</p>
                                )}
                            </div>
                            <div className="form-control w-full max-w-xs mx-auto my-2">
                                ...
                                ></input>
                                {errors.points && (
                                    <p className="text-red-500 mt-1 text-center font-light">{errors.points.message}</p>
                                )}
                            </div>
                            <div className="form-control w-full max-w-xs mx-auto my-2">
                    ...
                    <div className="p-4 text-base-content z-10 relative">
                        ...
                        <div className="forms border border-base-content border-opacity-30 py-4 rounded shadow-lg my-4">
                            <div className="form-control w-full max-w-xs mx-auto my-2">
                                ...
                                {errors.status && (
                                    <p className="text-red-500 mt-1 text-center font-light">{errors.status.message}</p>
                                )}
                            </div>
                        </div>
                        <div className="modal-action">
