...
const Home: NextPage = () => {
  ...
  <div
    className="max-w-screen-xl px-4 mx-auto my-64 lg:h-96 lg:items-center lg:flex"
  >
    <div className="max-w-3xl mx-auto text-center">
      <h1
        className="text-3xl font-extrabold text-transparent sm:text-5xl bg-clip-text bg-gradient-to-r from-purple-200 via-purple-400 to-purple-600"
      >
