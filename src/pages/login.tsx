...
export default function SignIn({ providers }: { providers: Provider[] }) {
    ...
    return (
        <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg bg-neutral-900 dark:bg-neutral-50">
            <div className="mx-auto flex w-fit flex-col gap-6 rounded-lg border-4 border-neutral-900 bg-neutral-100 p-10  duration-100 hover:-translate-x-1 hover:-translate-y-1 dark:border-neutral-50 dark:bg-neutral-800">
